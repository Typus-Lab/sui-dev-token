module sui_dev_token::afsui {
    ...
    fun init(witness: AFSUI, ctx: &mut TxContext) {
        let (treasury_cap, coin_metadata) = coin::create_currency(
            ...
            b"AFSUI",
            b"Typus AfSui",
            b"Fake AfSui on Sui testnet for testing only maintained by Typus Lab",
            option::some(url::new_unsafe_from_bytes(b"https://raw.githubusercontent.com/Typus-Lab/typus-asset/main/assets/AFSUI.svg")),
            ctx
        );
