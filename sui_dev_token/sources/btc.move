module sui_dev_token::btc {
    ...
    fun init(witness: BTC, ctx: &mut TxContext) {
        let (treasury_cap, coin_metadata) = coin::create_currency(
            ...
            b"BTC",
            b"Typus Bitcoin",
            b"Fake Bitcoin on Sui testnet for testing only maintained by Typus Lab",
            option::some(url::new_unsafe_from_bytes(b"https://raw.githubusercontent.com/Typus-Lab/typus-asset/main/assets/BTC.svg")),
            ctx
        );
